...
type LoginMScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'LoginM'
>;
              ...
              <View style={styles.modalContainer}>
                ...
                >
                  ...
                  <Text style={styles.subtext}>
                    Please fill the information to make it easier for us to get
                    to know you
                  </Text>
                  ...
                  <TouchableOpacity
                    style={[{ marginTop: isKeyboardVisible ? 0 : 20 }]}
                    onPress={handleLogin}
                  >
                  ...
                  <TouchableOpacity
                    style={[
                      styles.loginButton,
                      { marginTop: isKeyboardVisible ? 10 : 15 },
                    ]}
                    onPress={handleLogin}
                  >
